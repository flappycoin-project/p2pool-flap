...
nets = dict(
    ...
    litecoin_testnet=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=19327,
        BOOTSTRAP_ADDRS='litecointools.com p2pool.lurkmore.com forre.st vps.forre.st'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    dogecoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=22550,
        BOOTSTRAP_ADDRS='doge.altpool.pw doge.crypto49er.com doge-eu.crypto49er.com p2pool.lurkmore.com p2pool.name p2pool.org shitpost.asia'.split(' '),
